...
final class I18n
{
    private const EN = [
        ...
        'never' => 'Never',
        'fingerprint_own' => 'this node\'s certificate, pin it on the source',
        'fingerprint_configured' => 'peer certificate, configured manually',
        'fingerprint_learned' => 'peer certificate, learned automatically',
        'fingerprint_pending' => 'Not learned yet; obtained automatically on the first synchronization',
        ...
        'api_manual_in_use' => 'Own credentials in use',
        'api_managed_present' => 'Managed account opnsense-ha',
        'api_managed_none' => 'No credentials needed',
        'api_managed_pending' => 'Managed account pending',
        ...
        'secret_configured' => 'Configured; leave blank to keep',
        'api_password_configured' => 'Configured; leave blank to keep',
    ...
    private const ZH_CN = [
        ...
        'never' => '从未',
        'fingerprint_own' => '本机证书，供源端固定',
        'fingerprint_configured' => '对端证书，手工配置',
        'fingerprint_learned' => '对端证书，自动学习',
        'fingerprint_pending' => '尚未学习；首次同步时自动获取',
        ...
        'api_manual_in_use' => '使用自定义凭据',
        'api_managed_present' => '托管账号 opnsense-ha',
        'api_managed_none' => '无需凭据',
        'api_managed_pending' => '托管账号待安装',
        ...
        'source' => '配置来源',
        'receiver' => '配置接收方',
        'secret_configured' => '已配置；留空保持',
        'api_password_configured' => '已配置；留空保持',
        'mode_hot' => 'API 热更新',
